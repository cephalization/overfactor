...
2. ~~**Pi integration**~~ **Done 2026-08-15.** A project-local Pi package maps native session, prompt, agent, tool, settled, and shutdown events onto the shared SDK and reports them to the daemon without affecting Pi when Overfactor is unavailable.
